...
{
    $count = 0;
    $catch = $_POST['flightcode'];  // The flight code will be passed from the previous page
...
<head>
    ...
    <style>
        * {
        ...
        body {
            background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(Images/takeoff.jpg);
            height: 100vh;
...
<body>
    ...
    <form action="modifyflightdetails.php" method="post">
        <table class="a" cellspacing="30">
            <!-- Removed the Flight Code field since it's already selected in the previous page -->
            <tr>
                <td>Departure</td>
